<h2><a href="https://leetcode.com/problems/minimum-sum-after-divisible-sum-deletions">3654. Minimum Sum After Divisible Sum Deletions</a></h2><h3>Medium</h3><hr><p data-end="280" data-start="49">You are given an integer array <code data-end="86" data-start="80">nums</code> and an integer <code data-end="105" data-start="102">k</code>.</p>

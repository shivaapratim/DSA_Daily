<h2><a href="https://leetcode.com/quest/2026-offer-expedition-campaign/quiz/number-of-adjacent-elements-with-the-same-color/?envType=problem-list-v2&envId=interview-benchmark-i">2672. Number of Adjacent Elements With the Same Color</a></h2><h3>Medium</h3><hr><p>You are given an integer <code>n</code> representing an array <code>colors</code> of length <code>n</code> where all elements are set to 0&#39;s meaning <strong>uncolored</strong>. You are also given a 2D integer array <code>queries</code> where <code>queries[i] = [index<sub>i</sub>, color<sub>i</sub>]</code>. For the <code>i<sup>th</sup></code> <strong>query</strong>:</p>
